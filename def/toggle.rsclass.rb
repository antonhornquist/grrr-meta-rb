...
has_sc_init_method :arguments => [:parent=>nil}, {:origin=>nil}], :prefix_sc_arguments_with_arg => true

has_class_method :new_decoupled, :arguments => [{:parent=>nil}, {:origin=>nil}, {:num_cols=>nil}, {:num_rows=>nil}, {:enabled=>true}, {:nillable=>false}, {:orientation=>:vertical}]
...
has_class_method :new_nillable, :arguments => [{:parent=>nil}, {:origin=>nil}, {:num_cols=>nil}, {:num_rows=>nil}, {:enabled=>true}, {:coupled=>true}, {:orientation=>:vertical}]
